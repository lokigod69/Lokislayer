...
export const projects: Project[] = [
  ...
  },
  {
    id: 'deepdive',
    name: 'The Deep Dive',
    url: 'https://thedeepdive.space',
    description: 'Psychoanalysis exploration—dive into the unconscious mind',
    status: 'live',
    theme: {
      primaryColor: '#A78BFA',
      icon: '/icons/deepdive.svg',
    },
    mappings: {
      neuralMap: { position: { x: 0, y: -200 }, connections: ['matrixarena'] },
      anatomicalMap: { bodyPart: 'heart' },
      retroOS: { iconType: 'folder', filename: 'DeepDive' },
