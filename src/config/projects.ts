...
export const projects: Project[] = [
  ...
  },
  {
    id: 'crymera',
    name: 'Crymera',
    url: 'https://crymera.art',
    description: 'Fine art prints and photography gallery experience',
    status: 'live',
    theme: {
      primaryColor: '#A78BFA',
      icon: '/icons/crymera.svg',
    },
    mappings: {
      neuralMap: { position: { x: 0, y: -200 }, connections: ['matrixarena'] },
      anatomicalMap: { bodyPart: 'heart' },
      retroOS: { iconType: 'folder', filename: 'Gallery' },
      pirateBroadcast: { frequency: 108.0 },
      controlRoom: { panelType: 'tape-recorder' },
      vendingMachine: { slot: 'C2', productType: 'viewmaster' },
    },
  },
];
